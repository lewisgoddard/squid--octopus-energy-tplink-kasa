# Squid (Cloudflare Worker)

The Squid [Cloudflare Worker](https://workers.cloudflare.com/): it proxies and caches Octopus
Energy rates and switches TP-Link Kasa devices by those rates, backed by a
[Cloudflare D1](https://developers.cloudflare.com/d1/) database. (Repo overview:
[../README.md](../README.md); the TP-Link V2 relay: [../relay/README.md](../relay/README.md).)

- **Worker name:** `kraken`
- **D1 database name:** `kraken-db`

> All `wrangler` / `npm` commands below are run from this `squid/` directory.
